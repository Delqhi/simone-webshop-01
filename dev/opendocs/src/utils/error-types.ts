 ...
 */
export function isOpenDocsError(error: unknown): error is OpenDocsError {
...
export const DEFAULT_RETRY_CONFIG: RetryConfig = {
  ...
  baseDelayMs: 1000,
  maxDelayMs: 60000,
  shouldRetry: (error: OpenDocsError, attempt: number) => {
...
export async function withRetry<T>(
  ...
  let lastError: OpenDocsError | undefined;
  ...
  throw lastError || new OpenDocsError(
